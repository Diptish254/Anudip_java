...
// Write a program to find and display the duplicate characters in the string
	...
	{
	DuplicateChars D =new  DuplicateChars();                             // Create a class  object 
		     
	D. input_string();                                                    //call input_string method
	D. check_duplicate();                                                 // call method to check string duplicate word
	}
    }
